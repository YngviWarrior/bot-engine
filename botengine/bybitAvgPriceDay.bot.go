...
func (b *botengine) ByBitAvgPriceDay(configs *pb.TradeConfig, kline *rabbitmq.CombinedData, wg *sync.WaitGroup) {
	b.OperateAvgPriceDay(configs, kline, wg)
}

func (b *botengine) OperateAvgPriceDay(tradeConfig *pb.TradeConfig, kline *rabbitmq.CombinedData, wg *sync.WaitGroup) {
