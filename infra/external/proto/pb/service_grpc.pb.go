...
type ExchangeServiceClient interface {
	...
	GetTradeConfig(ctx context.Context, in *GetTradeConfigRequest, opts ...grpc.CallOption) (*GetTradeConfigResponse, error)
...
func (c *exchangeServiceClient) GetTradeConfig(ctx context.Context, in *GetTradeConfigRequest, opts ...grpc.CallOption) (*GetTradeConfigResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTradeConfigResponse)
	err := c.cc.Invoke(ctx, ExchangeService_GetTradeConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *exchangeServiceClient) ListAllOperation(ctx context.Context, in *ListAllOperationRequest, opts ...grpc.CallOption) (*ListAllOperationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListAllOperationResponse)
	err := c.cc.Invoke(ctx, ExchangeService_ListAllOperation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *exchangeServiceClient) UpdateOperation(ctx context.Context, in *UpdateOperationRequest, opts ...grpc.CallOption) (*UpdateOperationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateOperationResponse)
	err := c.cc.Invoke(ctx, ExchangeService_UpdateOperation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExchangeServiceServer interface {
	...
	GetTradeConfig(context.Context, *GetTradeConfigRequest) (*GetTradeConfigResponse, error)
...
func (UnimplementedExchangeServiceServer) GetTradeConfig(context.Context, *GetTradeConfigRequest) (*GetTradeConfigResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTradeConfig not implemented")
}
...
func (UnimplementedExchangeServiceServer) ListAllOperation(context.Context, *ListAllOperationRequest) (*ListAllOperationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListAllOperation not implemented")
}
func (UnimplementedExchangeServiceServer) UpdateOperation(context.Context, *UpdateOperationRequest) (*UpdateOperationResponse, error) {
...
func _ExchangeService_GetTradeConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTradeConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExchangeServiceServer).GetTradeConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExchangeService_GetTradeConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExchangeServiceServer).GetTradeConfig(ctx, req.(*GetTradeConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ExchangeService_ListAllOperation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListAllOperationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExchangeServiceServer).ListAllOperation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExchangeService_ListAllOperation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExchangeServiceServer).ListAllOperation(ctx, req.(*ListAllOperationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ExchangeService_UpdateOperation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateOperationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExchangeServiceServer).UpdateOperation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExchangeService_UpdateOperation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExchangeServiceServer).UpdateOperation(ctx, req.(*UpdateOperationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ExchangeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ExchangeService_GetTradeConfig_Handler,
		},
		{
		...
		{
			MethodName: "ListAllOperation",
			Handler:    _ExchangeService_ListAllOperation_Handler,
		},
		{
			MethodName: "UpdateOperation",
			Handler:    _ExchangeService_UpdateOperation_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "service.proto",
